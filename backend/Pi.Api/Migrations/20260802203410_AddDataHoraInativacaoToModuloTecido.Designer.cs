...
namespace Pi.Api.Migrations
{
    ...
    [Migration("20260802203410_AddDataHoraInativacaoToModuloTecido")]
    partial class AddDataHoraInativacaoToModuloTecido
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.Api.Models.Cliente", b =>
                {
                    ...
                    b.Property<string>("PortoDestino")
                        .HasColumnType("text")
                        .HasColumnName("porto_destinatario");
            ...
            modelBuilder.Entity("Pi.Api.Models.ProformaInvoice", b =>
                {
                    ...
                    b.Property<bool>("FlSimulacao")
                        .HasColumnType("boolean")
                        .HasColumnName("fl_simulacao");
                    ...
                    b.Property<string>("MoedaExibicao")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasDefaultValue("USD")
                        .HasColumnName("moeda_exibicao");
                    ...
                    b.Property<string>("TempoEntrega")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
